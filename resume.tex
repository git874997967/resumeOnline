...
\newRole{2019 -- present}
        {Software developer}
        {Microsoft}
        {Work as software engineer under Office IP antispam team. Response for maintaining and upgrading the ETL/ELT data pipeline, ADF obs, and components in ADF and ADLS. As well as generate ad-hoc visuals with different tools based on different requirements. }
\roleAchievements{Troubleshoot issues, errors in ETL services. Generate probes, monitors, alerts for different ETL components and services with C\# and PowerShell.}
...
{Migrated old ETL jobs and scripts, pipelines and visuals from on premise environments to the cloud and big data platform.}
...
{Improved the perforance of the offical website by optiming slowly running queries, utilized indexes , partitions and deadlock monitor via SQL Profiler and DTA.}
